...
describe "Trails API" do
  it "sends back the necessary information" do
    ...
    expect(trails_response["data"]["attributes"]["forecast"]["summary"]).to eq('clear sky')
    expect(trails_response["data"]["attributes"]["forecast"]["temperature"]).to eq(73.4)
